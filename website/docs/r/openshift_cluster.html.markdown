...
description: |-
  Manages a Managed Red Hat OpenShift Cluster (also known as ARO / Azure Red Hat OpenShift)
---
...
This example provisions a basic Managed OpenShift Cluster. Other examples of the `azurerm_openshift_cluster` resource can be found in [the `./examples/openshift` directory within the Github Repository](https://github.com/terraform-providers/terraform-provider-azurerm/tree/master/examples/openshift).
